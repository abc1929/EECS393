...
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ThirdPersonCPP/StarterContent/Textures/FireballExplosion.FireballExplosion_C,/Game/StarterContent/Textures/FireballExplosion.FireballExplosion_C", OverrideNativeName="FireballExplosion_C"))
class AFireballExplosion_C__pf3346625017 : public AActor
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="默认", OverrideNativeName="Explosion"))
