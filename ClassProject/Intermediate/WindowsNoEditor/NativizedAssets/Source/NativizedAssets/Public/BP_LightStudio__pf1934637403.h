...
#include "BP_LightStudio__pf1934637403.generated.h"
...
class ABP_LightStudio_C__pf1934637403 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_LightStudio_C__pf1934637403(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
