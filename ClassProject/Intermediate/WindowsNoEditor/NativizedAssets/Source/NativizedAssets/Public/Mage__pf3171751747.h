...
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/ThirdPersonCPP/Blueprints/Mage.Mage_C,/Game/ThirdPersonCPP/Blueprints/ThirdPersonCharacter.ThirdPersonCharacter_C", OverrideNativeName="Mage_C"))
class AMage_C__pf3171751747 : public AClassProjectCharacter
{
public:
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Health", Category="默认", ClampMin="-50", ClampMax="100", UIMin="0", UIMax="100", tooltip="HP", OverrideNativeName="Health"))
	float bpv__Health__pf;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(DisplayName="Stamina", Category="默认", tooltip="Stamina", UIMin="0", UIMax="100", ClampMin="0", ClampMax="100", OverrideNativeName="Stamina"))
	...
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_T_K2Node_InputKeyEvent_4"))
	virtual void bpf__InpActEvt_T_K2Node_InputKeyEvent_4__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_G_K2Node_InputKeyEvent_5"))
	virtual void bpf__InpActEvt_G_K2Node_InputKeyEvent_5__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_F_K2Node_InputKeyEvent_6"))
	virtual void bpf__InpActEvt_F_K2Node_InputKeyEvent_6__pf(FKey bpp__Key__pf);
	UFUNCTION(meta=(OverrideNativeName="InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_7"))
	virtual void bpf__InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_7__pf(FKey bpp__Key__pf);
