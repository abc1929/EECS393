...
#include "ForceField__pf3171751747.h"
...
#endif
AForceField_C__pf3171751747::AForceField_C__pf3171751747(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AForceField_C__pf3171751747::StaticClass() == GetClass()))
	{
		AForceField_C__pf3171751747::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__StaticMesh__pf->StaticMesh = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AForceField_C__pf3171751747::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AForceField_C__pf3171751747::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	{
		__Local__0 = (FBodyInstance::StaticStruct())->FindPropertyByName(FName(TEXT("PhysMaterialOverride")));
		check(__Local__0);
		__Local__1 = __Local__0;
	}
	auto& __Local__2 = (*(__Local__0->ContainerPtrToValuePtr<UPhysicalMaterial* >(&(bpv__StaticMesh__pf->BodyInstance), 0)));
	__Local__2 = CastChecked<UPhysicalMaterial>(CastChecked<UDynamicClass>(AForceField_C__pf3171751747::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	if(!bpv__StaticMesh__pf->IsTemplate())
	{
		bpv__StaticMesh__pf->BodyInstance.FixupData(bpv__StaticMesh__pf);
	}
}
void AForceField_C__pf3171751747::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
void AForceField_C__pf3171751747::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__StaticMesh_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature"));
	...
	__Local__5.FunctionNameToBind = FName(TEXT("BndEvt__StaticMesh_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature"));
}
void AForceField_C__pf3171751747::bpf__ExecuteUbergraph_ForceField__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				if(IsValid(b0l__K2Node_DynamicCast_AsMage2__pf))
				{
					b0l__K2Node_DynamicCast_AsMage2__pf->bpf__PlayerInForceField__pf();
				}
				CurrentState = -1;
				break;
			}
		case 2:
			{
				b0l__K2Node_DynamicCast_AsMage2__pf = Cast<AMage_C__pf3171751747>(b0l__K2Node_ComponentBoundEvent_OtherActor2__pf);
				b0l__K2Node_DynamicCast_bSuccess2__pf = (b0l__K2Node_DynamicCast_AsMage2__pf != nullptr);;
...
void AForceField_C__pf3171751747::bpf__ExecuteUbergraph_ForceField__pf_1(int32 bpp__EntryPoint__pf)
{
	int32 CurrentState = bpp__EntryPoint__pf;
	do
	{
		...
		case 3:
			{
				if(IsValid(b0l__K2Node_DynamicCast_AsMage__pf))
				{
					b0l__K2Node_DynamicCast_AsMage__pf->bpf__PlayerOutForceField__pf();
				}
				CurrentState = -1;
				break;
			}
		case 5:
			{
				b0l__K2Node_DynamicCast_AsMage__pf = Cast<AMage_C__pf3171751747>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
...
void AForceField_C__pf3171751747::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf)
{
	...
	bpf__ExecuteUbergraph_ForceField__pf_1(6);
}
void AForceField_C__pf3171751747::bpf__BndEvt__StaticMesh_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, /*out*/ FHitResult const& bpp__SweepResult__pf)
{
	...
	bpf__ExecuteUbergraph_ForceField__pf_0(4);
}
void AForceField_C__pf3171751747::bpf__UserConstructionScript__pf()
{
}
void AForceField_C__pf3171751747::__StaticDependencies_CommonAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	FBlueprintDependencyData LocAssets[] =
	{
		FBlueprintDependencyData(TEXT("/Game/ThirdPersonCPP/Cylinder_Brush_StaticMesh"), TEXT("Cylinder_Brush_StaticMesh"), TEXT("/Script/Engine"), TEXT("StaticMesh")),
		FBlueprintDependencyData(TEXT("/Engine/EngineMeshes/M_Mat_UnrealTech"), TEXT("M_Mat_UnrealTech"), TEXT("/Script/Engine"), TEXT("Material")),
		FBlueprintDependencyData(TEXT("/Engine/EngineMaterials/DefaultPhysicalMaterial"), TEXT("DefaultPhysicalMaterial"), TEXT("/Script/Engine"), TEXT("PhysicalMaterial")),
...
void AForceField_C__pf3171751747::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
}
void AForceField_C__pf3171751747::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_CommonAssets(AssetsToLoad);
	FBlueprintDependencyData LocAssets[] =
	{
...
struct FRegisterHelper__AForceField_C__pf3171751747
{
	FRegisterHelper__AForceField_C__pf3171751747()
	{
		FConvertedBlueprintsDependencies::Get().RegisterClass(TEXT("/Game/ThirdPersonCPP/Blueprints/ForceField"), &AForceField_C__pf3171751747::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AForceField_C__pf3171751747 Instance;
};
FRegisterHelper__AForceField_C__pf3171751747 FRegisterHelper__AForceField_C__pf3171751747::Instance;
#ifdef _MSC_VER
#pragma warning (pop)
#endif
